<?php
    ...
    $sqlc = $conn->prepare("SELECT * FROM reltab WHERE FK_ID_COOR = 11");
    $sqlc->execute();
    ...
    $sql = $conn->prepare("SELECT * FROM reltab WHERE FK_ID_COOR = 11");
    $sql->execute();
...
<?php
    ...
    $sql_aut = $conn->prepare("SELECT COUNT(ID_REL) as count FROM reltab WHERE FK_ID_COOR = 11");
    $sql_aut->execute();
